...
public class MainActivity extends AppCompatActivity {
    ...
    private String apiKey = "fab8ce741197bf8297fe6331c32e60e6";
    private String ville = "Agadir";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String lien ="https://metaweather.com/api/location/search/?query=agadir";
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET,lien, null, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainActivity.this, "Conexion error...", Toast.LENGTH_SHORT).show();
            }
        });
